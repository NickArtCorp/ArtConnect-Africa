...
import { useAuthStore, useMessagesStore, useLanguageStore, usePortfolioStore, useReferenceStore } from '@/store';
            ...
            <div className="bg-card rounded-2xl border border-border/50 p-6" data-testid="profile-card">
              <div className="text-center mb-6">
                ...
                <div className="flex justify-center gap-2 mt-2">
                  <Badge className="bg-primary/10 text-primary border-0">{translateSector(user.sector, sectors, language)}</Badge>
                </div>
                <p className="text-sm text-muted-foreground mt-2">{translateDomain(user.domain, domains, user.sector, language)}</p>
              </div>
